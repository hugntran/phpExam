...
<head>
    ...
    <link rel="stylesheet" href="css/bs4Toast.css" type="text/css">
</head>
<body>
    <div class="container">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="{{url('/searchByName')}}" method="GET">
                           
                    <input value="{{app('request')->input('keyword')}}" class="form-control mr-sm-2" name="keyword" type="text" placeholder="Search">
